...
container.register(
    'CreateEmpleado',
    new CreateEmpleado(prismaEmpleadoRepository)
)
container.register(
    'GetAllEmpleados',
    new GetAllEmpleados(prismaEmpleadoRepository)
)
container.register(
    'CreateSolicitud',
    new CreateSolicitud(prismaSolicitudRepository)
)
container.register('GetSolicitud', new GetSolicitud(prismaSolicitudRepository))
container.register(
    'GetAllSolicitudes',
    new GetAllSolicitudes(prismaSolicitudRepository)
)
container.register(
    'DeleteSolicitud',
    new DeleteSolicitud(prismaSolicitudRepository)
)
container.register(
    'RegisterUsuario',
    new RegisterUsuario(prismaUsuarioRepository)
)
